...
class CertificationForecast extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      runReport: '',
    ...
    this.columns = [
      ...
      {
        title: 'Expected Forecast Date',
        dataIndex: 'expectedForecastDate',
      },
    ];
      ...
      <PageHeaderWrapper>
        <Card>
          <div className="screen-header">
            <h1 className="page-title">Certification Forecast Report</h1>
          </div>
          ...
          <div className="attrition-header-filter-container">
            ...
            <div style={{ display: 'flex' }}>
              ...
              <Checkbox defaultChecked={true}>Expected Forecast Date</Checkbox>
            </div>
            <br />
          ...
          <div style={this.state.runReport === 'run' ? {} : { display: 'none' }}>
            <h1>Certification Forecast Report</h1>
...
export default CertificationForecast;
