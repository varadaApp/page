...
class TrainingForecast extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      runReport: '',
      ...
      dataSource: [
        {
          key: '0',
          training: 'Windows Server Training Level 3',
      ...
      <PageHeaderWrapper>
        <Card>
          <div className="screen-header">
            <h1 className="page-title">Training Forecast Report</h1>
          </div>
          ...
          <div className="mobility-header-filter-container">
            ...
            <div style={{ display: 'flex' }}>
              ...
              <Checkbox defaultChecked={true}>Expected Forecase Date</Checkbox>
            </div>
            <br />
          ...
          <div style={this.state.runReport === 'run' ? {} : { display: 'none' }}>
            <h1>Training Forecast Report</h1>
...
export default TrainingForecast;
